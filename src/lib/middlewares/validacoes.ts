...
export async function requestBodyFieldPresentes<T>(objeto: T,req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  if(propriedadesFaltantes.length) res.status(400).json({
